                    ...
                    children: [
                      ...
                      Column(
                        children:  [
                          HistoryWidget(
                            title: "David Harris",
                            description: local.decline,
                            price: "28",
                            description1: local.plumber,
                            date: '20/2/2025',
                          ),
                          SizedBox(height: 7),
                          HistoryWidget(
                            title: "Amanda Wood",
                            description: local.completed,
                            price: "30",
                            description1: local.gardner,
                            date: '10/4/2025',
                          ),
                          SizedBox(height: 7),
                          HistoryWidget(
                          ...
                          HistoryWidget(
                            ...
                            description: local.completed,
                            price: "40",
                            description1: local.electrician,
                            date: '22/7/2025',
                          ),
                        ],
                      ),
